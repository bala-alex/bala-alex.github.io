...
const singlePlanTextTranslated = window.location.pathname.includes('/ro/') ? 'Escrow SaaS (Singur)' : window.location.pathname.includes('/de/') ? 'SaaS-Escrow (Einzeln)' : window.location.pathname.includes('/es/') ? 'Custodia de SaaS (Single)' : window.location.pathname.includes('/fr/') ? 'Entiercement de SaaS (Unique)' : window.location.pathname.includes('/nl/') ? 'SaaS-escrow (Enkel)' : 'SaaS Escrow (Single)';
const multiPlanTextTranslated = window.location.pathname.includes('/ro/') ? 'Escrow SaaS (Multi)' : window.location.pathname.includes('/de/') ? 'SaaS-Escrow (Multi)' : window.location.pathname.includes('/es/') ? 'Custodia de SaaS (Multi)' : window.location.pathname.includes('/fr/') ? 'Entiercement de SaaS (Multi)' : window.location.pathname.includes('/nl/') ? 'SaaS-escrow (Multi)' : 'SaaS Escrow (Multi)';
