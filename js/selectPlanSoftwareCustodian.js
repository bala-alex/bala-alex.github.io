...
const singlePlanTextTranslated = window.location.pathname.includes('/ro/') ? 'Software Custodian (Singur)' : window.location.pathname.includes('/de/') ? 'Software-Verwalter (Einzeln)' : window.location.pathname.includes('/es/') ? 'Agente de custodia de software (Single)' : window.location.pathname.includes('/fr/') ? 'Conservation de logiciel (Unique)' : window.location.pathname.includes('/nl/') ? 'Software Custodian (Enkel)' : 'Software Custodian (Single)';
const multiPlanTextTranslated = window.location.pathname.includes('/ro/') ? 'Software Custodian (Multi)' : window.location.pathname.includes('/de/') ? 'Software-Verwalter (Multi)' : window.location.pathname.includes('/es/') ? 'Agente de custodia de software (Multi)' : window.location.pathname.includes('/fr/') ? 'Conservation de logiciel (Multi)' : window.location.pathname.includes('/nl/') ? 'Software Custodian (Multi)' : 'Software Custodian (Multi)';
